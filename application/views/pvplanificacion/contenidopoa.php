            ...
            <fieldset>
                <table width="100%" border="0px">
                    ...
                    <tr>
                        ...
                        <td><b><?php echo Form::label('otro_tipocontratacion', 'Otro:', array('class' => 'form')); ?></b></td>
                        <td><?php echo Form::input('otro_tipocontratacion',$poa->otro_tipocontratacion,array('class'=>'form','id'=>'otro_tipocontratacion')); ?></td>
                    </tr>
